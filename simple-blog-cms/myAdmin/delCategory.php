...
if (!empty($_POST['akceptacja']) && $_POST['akceptacja']==1 && is_numeric($_GET['id'])) 
{
    ...
    header("Location: category.php"); /* Redirect browser */
}
?>
<h2>Usuń Kategorie</h2><br/>
<form action="delCategory.php?id=<?php if (is_numeric($_GET['id'])) { echo($_GET['id']); } ?>" method="post"><p class="tresc">
